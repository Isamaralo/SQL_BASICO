...
SET DEFINE OFF;
Insert into HR.INCREMENTOS_SALARIO (INCREMENTOS_ID,EMPLOYEE_ID,SALARIO_ANTERIOR,SALARIO_POSTERIOR,FECHA) values ('201','200','168686','202423',to_date('25/01/17','DD/MM/RR'));
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('200','Jennifer','Whalen','JWHALEN','515.123.4444',to_date('17/09/03','DD/MM/RR'),'AD_ASST','202422,65',null,'101','10');
...
FOR EACH ROW
BEGIN
INSERT INTO INCREMENTOS_SALARIO VALUES (:OLD.employee_id+1, :OLD.employee_id, :OLD.salary, :NEW.salary, SYSDATE);
END;

--SELECT EMPLOYEE_ID, SALARIO_ANTERIOR, SALARIO_POSTERIOR, FECHA FROM INCREMENTOS_SALARIO WHERE FECHA > '25/01/17';
/
